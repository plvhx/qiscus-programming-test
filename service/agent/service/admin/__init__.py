...
class Admin(Abstract):
	...
	def admin_get_other_agents(self, room_id, limit=None,
		                             cursor_after=None, cursor_before=None,
		                             search=None, headers=None):
	...
	def admin_get_available_agents(self, room_id, limit=None,
		                                 cursor_after=None, cursor_before=None,
		                                 is_available_in_room=None, headers=None):
